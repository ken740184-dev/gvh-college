      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-32">
        ...
        <div>
          ...
          <div className="space-y-20">
            {[
              { year: "1906", title: "Born in Hosaritti", text: "Born on June 6, 1906 in Hosaritti, Haveri district, to father Veerappa and mother Veeramma — the youngest of five sons. From birth displayed extraordinary mathematical talent." },
              ...
              { year: "1927–1928", title: "Founding Bharatiya Taruna Sangha & Gandhi Ashram", text: "Founded Bharatiya Taruna Sangha in Dharwad (1927) gathering enthusiastic youth. In 1928, founded the Gandhi Ashram in Hosaritti modelled on Sabarmati Ashram — enabling 5,000 Satyagrahis from surrounding villages to join national movements." },
              { year: "1930", title: "Dandi March & Salt Satyagraha", text: "Joined Gandhi at Jambusara village near Ahmedabad on March 22, 1930 during the Dandi March. Jailed twice during the Salt Satyagraha. Ground 70 pounds of jowar daily in prison. Stood as a lion against the British." },
              { year: "1932", title: "Non-Cooperation Movement", text: "Two years in jail during the Non-Cooperation Movement. In prison, urged all prisoners to do cleaning work and undertook a 13-day fast to protest prison conditions." },
              ...
              { year: "1942", title: "Quit India Movement", text: "Three years rigorous imprisonment in the Quit India (Chale Jao) Movement. When Gandhi fasted for 21 days in Yerewada Jail in February 1943, Gudleppa fasted for 21 days in solidarity in Hindlagi Prison, Belagavi." },
              ...
              { year: "1963", title: "Building Institutions", text: "Collected 6 lakh rupees in just 3 months and gave them to K.L.E. Society, establishing today's K.L.E. Gudleppa Hallikeri College, Haveri. Also played key roles in College of Business Management (inaugurated by President Radhakrishnan), Nijalingappa College, Bengaluru, and Karnataka Medical College, Hubballi." },
              { year: "1971", title: "Eternal Rest — May 15, 1971", text: "Elected Chairman of Karnataka Legislative Council for a second term in 1971. This great son of Bharatmata, who dedicated his entire life to the service of the nation, attained eternal rest on May 15, 1971. His memory lives on in the institutions he built." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial="hidden"
