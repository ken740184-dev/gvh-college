          ...
          >
            {(() => {
              ...
              return newsItems.map((news) => {
                const currentBannerIndex = news.isBanner ? bannerIndex++ : 0;
                return (
                  <motion.article 
                    key={news._id} 
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className={`font-bold font-sans text-slate-800 uppercase tracking-tight leading-snug mb-3 group-hover:text-accent transition-colors ${news.isBanner ? "text-2xl md:text-3xl" : "text-xl"}`}>
                        {news.title}
                      </h3>
