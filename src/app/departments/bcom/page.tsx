      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-bold text-navy-deep mb-1">
                    {t("dept.bcom_core_title")}
                  </h4>
                  <p className="text-secondary-text leading-relaxed">
                    {t("dept.bcom_core_desc")}
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Combinations Table */}
            <h3 className="text-2xl font-sans font-bold mb-4">{t("dept.bcom_combinations_title")}</h3>
            <p className="text-secondary-text mb-6 leading-relaxed">
              {t("dept.bcom_combinations_desc")}
            </p>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-navy-deep text-white text-sm uppercase tracking-wider font-semibold">
                    <th className="py-4 px-6">{t("dept.bcom_col_combination")}</th>
                  </tr>
                </thead>
            ...
            <h3 className="text-2xl font-sans font-bold mb-4">{t("dept.bcom_eligibility_title")}</h3>
            <p className="text-secondary-text leading-relaxed mb-12">
              {t("dept.bcom_eligibility_desc")}
            </p>

            <h3 className="text-2xl font-sans font-bold mb-6">{t("dept.career")}</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
              {t("dept.bcom_careers").split(", ").map((career) => (
            ...
            <div className="bg-gray-50 border border-border-color rounded-lg p-8 sticky top-28">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-bold">{t("dept.seats_120")}</span>
                </li>
              </ul>
